/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9889ac6b205e5dbb770e9fe94e40cd69)
// Runtime types generated with workerd@1.20260826.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
	kv: KVNamespace;
	suppressed_kv: KVNamespace;
	r2: R2Bucket;
	DROP_DB: Hyperdrive;
	WEBSITE_CC_DB: Hyperdrive;
	WEBSITE_RL_DB: Hyperdrive;
	...
	DROP_REPORTS_CLEANUP: Workflow<Parameters<import("./worker/index").DropReportsCleanupWorkflow['run']>[0]['payload']>;
	DROP_DOWNLOADER: Workflow<Parameters<import("./worker/index").DropDownloaderWorkflow['run']>[0]['payload']>;
	DROP_KV_REPAIR: Workflow<Parameters<import("./worker/index").DropKvRepairWorkflow['run']>[0]['payload']>;
	DROP_STATUS_REPORT: Workflow<Parameters<import("./worker/index").DropStatusReportWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CH_URL" | "CH_USER" | "LOGS_HOST">> {}
}
