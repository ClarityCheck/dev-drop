/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7eed369e9f4d82e7bda2c1fde960c34a)
...
interface __BaseEnv_Env {
	...
	DROP_REPORTS: Workflow<Parameters<import("./worker/index").DropReportsWorkflow['run']>[0]['payload']>;
	DROP_SYNC: Workflow<Parameters<import("./worker/index").DropSyncWorkflow['run']>[0]['payload']>;
}
